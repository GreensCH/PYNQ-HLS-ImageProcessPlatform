...
proc create_root_design { parentCell } {
  ...
  set ImageProcessor_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ImageProcessor:1.0 ImageProcessor_0 ]
  ...
  set canny_edge_detection_0 [ create_bd_cell -type ip -vlnv blog.yourenlv.top:hls:canny_edge_detection:1.0 canny_edge_detection_0 ]
  ...
  connect_bd_intf_net -intf_net axi_vdma_1_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_1/M_AXIS_MM2S] [get_bd_intf_pins canny_edge_detection_0/axis_in]
  ...
  connect_bd_intf_net -intf_net canny_edge_detection_0_axis_out [get_bd_intf_pins axi_vdma_1/S_AXIS_S2MM] [get_bd_intf_pins canny_edge_detection_0/axis_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ImageProcessor_0/s_axi_CTRL] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins canny_edge_detection_0/s_axi_CONTROL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net rst_ps7_0_150M_peripheral_aresetn [get_bd_pins ImageProcessor_0/ap_rst_n] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins canny_edge_detection_0/ap_rst_n] [get_bd_pins canny_edge_detection_0/ap_rst_n_s_axi_aclk] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_150M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ImageProcessor_0/s_axi_CTRL/Reg] SEG_ImageProcessor_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs canny_edge_detection_0/s_axi_CONTROL_BUS/Reg] SEG_canny_edge_detection_0_Reg
