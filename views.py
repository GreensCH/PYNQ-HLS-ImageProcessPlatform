...
class DisplayImagesHandle(tornado.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        self.render('displayimages.html', title_word=picture_mode+'App Display',
                    orginal_image=imb64_cache.fast_mat2base64(mat_buf),
                    ...
                    processed_pl_time=pl_time#ps_time*3/5,#pl_time,#ps_time*4/5,
                    )
